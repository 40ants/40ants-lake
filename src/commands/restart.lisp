(uiop:define-package #:40ants-lake/commands/restart
  (:use #:cl)
  (:import-from #:lake)
...
(in-package #:40ants-lake/commands/restart)


(lake:task ("restart" (env "dev")) ()
  "Restarts all daemon apps in a given environment (by default it is dev)."
