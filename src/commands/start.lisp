(uiop:define-package #:40ants-lake/commands/start
  (:use #:cl)
  (:import-from #:lake)
...
(in-package #:40ants-lake/commands/start)


(lake:task ("start" (env "dev")) ()
  "Starts all daemon apps in a given environment (by default it is dev)."
